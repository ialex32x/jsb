#ifndef JAVASCRIPT_LANG_H
#define JAVASCRIPT_LANG_H
...
namespace jsb
{
    // class JavaScriptBridge : public Script
    // {
    //     // referenced module_id in commonjs
    //     String module_id;
    // };

    class JavaScriptBridgeLanguage : public ScriptLanguage
    {
    public:
        JavaScriptBridgeLanguage();
        virtual ~JavaScriptBridgeLanguage() override;
