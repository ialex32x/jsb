...
define("tsd_codegen", ["require", "exports", "godot"], function (require, exports, godot_1) {
    "use strict";
...
define("scratchpad", ["require", "exports", "godot"], function (require, exports, godot_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function () {
        const temp = new godot_2.Node();
    })();
    class LocalNode extends godot_2.Node {
    }
    ...
    console.log(typeof godot_2.Vector3);
    console.assert(godot_2.Vector3.Axis.AXIS_X == 0);
    const v1 = new godot_2.Vector3(1, 1, 1);
    const v2 = new godot_2.Vector3(2, 3, 4);
    console.log("dot", v2.dot(v1));
    const v3 = v1.move_toward(v2, 0.5);
    console.log(v3.x, v3.y, v3.z);
});
define("main_entry", ["require", "exports", "godot", "tsd_codegen", "scratchpad"], function (require, exports, godot_3, tsd_codegen_1, scratchpad_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    tsd_codegen_1 = __importDefault(tsd_codegen_1);
    // entry point (editor only)
    // log, warn, error, assert are essentially supported
    console.log("main entry in editor");
    console.assert(typeof godot_3.Node === "function");
    let timer_id;
    let times = 5;
    ...
    function test_async() {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(godot_3.Engine.get_time_scale());
    ...
    if (jsb.TOOLS_ENABLED) {
        let tsd = new tsd_codegen_1.default(".");
        tsd.emit();
